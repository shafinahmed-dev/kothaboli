...
export function ThreadCard({ thread }: { thread: any }) {
  ...
  return (
    <Link 
      ...
      className="block w-full p-4 md:p-5 rounded-3xl bg-neutral-900/50 border border-neutral-800/80 hover:border-neutral-700 transition-colors duration-150 group mb-4 shadow-lg backdrop-blur-sm"
    >
