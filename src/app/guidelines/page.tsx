  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 space-y-8 pb-24">
      ...
      <section className="space-y-4 text-neutral-300 leading-relaxed font-medium">
        <p className="text-lg text-neutral-400">KothaBoli operates across 14 dedicated frequency boards. To keep the signal clear, we ask all archetypes to abide by a simple set of norms.</p>
